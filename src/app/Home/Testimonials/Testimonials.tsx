...
const Testimonials: React.FC = () => {
  return (
    <div className='w-full flex justify-center bg-gray-100 py-20 px-5'>
      <div className="w-full">
        <h2 className='heading2 text-center mb-6' data-aos-desktop="fade-up" data-aos-mobile="fade-up">Rider Testimonials</h2>
